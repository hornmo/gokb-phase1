...
<body>
	...
	<div id="mainarea" class="panel panel-default">
		<div class="panel-body">
			<p>
			This is a new page to try to let you upload an eBook file. Please supply all fields. Datafiles are associated with
			Ingestion Profiles; you can select an existing profile to use, or create a new one.
      		</p>
      <p>
